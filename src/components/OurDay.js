  ...
  render() {
    return (
      <section id="our-day">
        <div className="our-day-flexbox">
          ...
          <div className="our-day-pull-right">
            ...
            <ul>
              ...
              <li>
                At both the church and the evening venue there will be uneven
                ground and grass so please bear this in mind when choosing
                footwear. Our evening reception will also be under canvas so
                please bring warm clothing and wet weather gear just in case.
              </li>
            </ul>
            <p>
              <span class="strong">
                We’d also love it if you could please bring along a coconut to
                our reception!
              </span>
            </p>
          </div>
        ...
        <h3>1 o’clock</h3>
        <p>
          The ceremony starts at 1 o'clock so please arrive 15 minutes before.
          There is plenty of parking on the field beside the church and this
          will be signed from the main road. It’s worth having brunch/lunch
          before you arrive as the ceremony will be around 1 hour.
        </p>
        <p>
          After the ceremony, please make your own way to the reception venue.
          You will drive through Stockbridge on your way so please feel free to
          stop by your hotel to check in.
        </p>
        <h2>The Reception</h2>
        <address>
        ...
        <p>
          ...
          Please let us know in your RSVP if you would like a seat on the bus!
        </p>
        ...
        <p>
          We’d love you to join us in the Courtyard of The Greyhound on The Test
          for bacon butties and Bloody Marys before you head off on Sunday
          morning. We’ll plan to stay around until the last people leave!
        </p>
      </section>
    )
  }
